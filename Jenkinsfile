...
pipeline {
  ...
  stages {
	...
	stage('DockerImg Push'){
		steps{
			withDockerRegistry(credentialsId: 'c447e8d5-38e6-40e9-a184-f19a52d57a0', url: 'https://index.docker.io') {
	sh 'docker tag sho317/docknginix:${BUILD_NUMBER} sho317/docknginix:${BUILD_NUMBER}'
